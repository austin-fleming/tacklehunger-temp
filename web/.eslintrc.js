...
module.exports = {
  ...
  overrides: [
    ...
    // All Storybook files
    {
      files: ['*.stories.*'],
      rules: {
        // Allow multiple components & default exports in story files
    ...
    // All files in pages folder
    {
      files: ['**/pages/**/*'],
      rules: {
        // Enforce default exports
        'import/no-default-export': 'off',
        'import/prefer-default-export': 'error',
      },
    },
    // All root Javascript files
    {
      files: ['./*.js'],
      rules: {
    ...
    // Allow devDependencies in these folders (root js, cypress, storybook files)
    {
      files: ['./*.js', '**/cypress/**/*', '*.stories.*'],
      rules: {
